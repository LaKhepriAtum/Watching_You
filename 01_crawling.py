...
# print(contents)
    ...
    # contentt=[]
    # for content in content:
#     #     content.find('p',{'class':'txt'}).get_text()
print(contents[0])


        # contentt.append(content)
        # print(contentt)
    ...
    # driver.get(url)
    # titles_ko.append(query)
    # title = driver.find_element_by_css_selector('#content > div:nth-child(3) > ul > li:nth-child(1) > div.thumb_area')
    # print(title)
